...
class gui__template( ttk.Frame ):
    ...
    def create__widgets( self ):
        ...
        self.params [key]   = [ 0, 200,  80, 1 ]    # -- [ min, max, init, increment ] -- #
        ...
        self.params [key]   = [ 0, 255, 80, 1 ] # [ min, max, init, increment ]
        self.values [key]   = tk.StringVar()
        self.values [key].set( str( self.params[key][ini_] ) )
    ...
    def define__positionsOfWidgets( self ):
        ...
        self.posits ["opencv"]           = [  0.1,  0.30, 0.8, 0.28 ]
        self.posits ["plot"]             = [  0.1,  0.65, 0.8, 0.28 ]
