...
class gui__template( ttk.Frame ):
    ...
    def define__positionsOfWidgets( self ):
        ...
        self.posits ["FileDialog01"]     = [  0.7,  0.7  ]
        return()
...
# ========================================================= #
# ===  Not in use :: old, obsolete tk-routines          === #
# ========================================================= #

# # ------------------------------------------------- #
# # --- [8] Listbox widgets                       --- #
# # ------------------------------------------------- #
# self.params ["Listbox01"] = tk.StringVar( value=["Type-A", "Type-B", "Type-C"] )
# self.widgets["Listbox01"] = tk.Listbox( self, listvariable=self.params["Listbox01"] )
# self.widgets["Listbox01"].pack()
